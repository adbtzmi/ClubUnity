    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-8 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                <p class="text-gray-900">{{ __("This is application management") }}</p>
            </div>
            <br>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="px-2 py-1 rounded text-white {{ $application->status == 'Approve' ? 'bg-green-500' : ($application->status == 'Reject' ? 'bg-red-500' : 'bg-gray-500') }}">
                                                {{ $application->status }}
                                            </span>
                                        </td>
                                        <td>
